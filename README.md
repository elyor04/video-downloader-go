...
- Add several URLs and download up to 5 at a time; the rest wait in a queue and start automatically
...
To build the Windows NSIS installer, pass `-installscope user` (recommended):
